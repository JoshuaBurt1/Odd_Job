...
export default function PublicProfilePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4 sm:px-6 w-full box-border">
      
      {/* Header Section */}
      <div className="w-full flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-12 bg-white dark:bg-zinc-900 p-8 rounded-2xl shadow-sm border border-zinc-100 dark:border-zinc-800 box-border">
        <div className="w-24 h-24 rounded-full bg-blue-100 dark:bg-blue-900/50 flex items-center justify-center text-blue-600 dark:text-blue-400 text-4xl font-bold shadow-inner shrink-0">
      ...
      <div className="space-y-12 w-full">
        ...
        <section className="w-full">
          <div className="flex items-center gap-4 mb-6 pb-2 border-b border-zinc-200 dark:border-zinc-800 w-full">
          ...
          {/* items-stretch forces all items to span 100% of the container width */}
          <div className="w-full flex flex-col items-stretch space-y-4">
            {profile.seekerReviews && profile.seekerReviews.length > 0 ? (
              ...
              <div className="w-full p-8 text-center rounded-xl bg-zinc-50 dark:bg-zinc-900/50 border border-dashed border-zinc-200 dark:border-zinc-800 box-border">
...
function ReviewCard({ review }: { review: Review }) {
  return (
    <div className="w-full p-5 border border-zinc-100 dark:border-zinc-800 rounded-xl bg-white dark:bg-zinc-900 shadow-sm hover:shadow-md transition-shadow box-border">
      <div className="flex justify-between items-start mb-3 w-full">
        <div className="min-w-0 flex-1">
          ...
          <div
            className="text-xs text-zinc-500 mt-0.5 truncate pr-4"
        ...
        <div className="flex items-center bg-zinc-50 dark:bg-zinc-800 px-2 py-1 rounded text-amber-500 font-medium text-sm shrink-0">
          ★ {review.rating.toFixed(1)}
        </div>
      </div>

      {review.comment && (
        <p className="text-sm mt-3 text-zinc-700 dark:text-zinc-300 italic break-words whitespace-pre-line">
          "{review.comment}"
        </p>
      )}
